import pytest
from validador_idades import ValidadorIdade
...
class TestValidadorIdade:
    ...
    def test_idade_abaixo_0(self):
        assert self.validador.validar_idade(-1) == "Idade infomada fora do limite permitido."
    ...
    def test_idade_acima_200(self):
        assert self.validador.validar_idade(210) == "Idade acima do limite permitido."
